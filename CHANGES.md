...
- 改进录音统计信息显示
  ...
  - 添加使用模型和语言信息
- 修复auto模式报错
  - 移除transcribe方法中的target_language参数
  - 优化语言检测逻辑
...
## 2024-04-08 (0.23.29)
- 修复了信号连接问题，移除了对不存在的 `signals.toggle_recording_signal` 的引用
- 优化了录音控制逻辑，直接使用 `FloatingWindow` 类的 `toggle_recording_signal`
- 简化了回调函数设置逻辑
