...
## 2024-04-13 (0.23.41)
- 改进：优化菜单项透明度，从60%调整为30%，增强白色背景可见度
- 修复：提高下拉菜单项可见性，解决看不清菜单内容的问题
- 优化：菜单背景色设置为rgba(255, 255, 255, 178)，视觉效果更佳

## 2024-04-13 (0.23.40)
- 改进：优化语言选择功能，标签改为"Translate Your Voice To:"，更清晰地表示功能
- 新增：增加泰语翻译支持，现在可以将语音翻译成泰文
- 修复：确认set_device方法正常工作，保证设备选择正确生效
- 优化：改进UI标签和提示，使用户更容易理解功能
